...
After testing both of our final models on the validation dataset, we can see that the error for both models is marginally lower compared to the testing set. Potentially, this is because our validation set data more closely resembles our training set than our testing dataset. However, since the difference is so minor, we can conclude that our models and their respective errors are consistent across multiple datasets.
