...
library(pROC)
predictions_rf <- predict(final_rf, test_data, type = "prob")
binary_target <- ifelse(test_data$ChurnLabel == "Yes", 1, 0)
roc_values_rf <- roc(test_data$ChurnLabel, predictions_rf[, 2])
...
predictions_lr <- predict(finalLR, test_data, type="resp")
binary_target <- ifelse(test_data$ChurnLabel == "Yes", 1, 0)
roc_values_lr <- roc(test_data$ChurnLabel, predictions_lr)
