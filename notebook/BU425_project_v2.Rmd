...
newdata<- select(data, -c(Lat.Long, Count, CLTV, Churn.Score, Latitude, Longitude, Zip.Code,CustomerID,Churn.Reason, Churn.Label,City))
head(newdata)
...
```{r}
# rename the columns
names(newdata) <- c("Gender", "SeniorCitizen",
                    "Partner", "Dependents",
                    "TenureMonths","PhoneService",
...
newdata <- newdata%>%
  mutate(Gender = factor(Gender, levels=(c("Male","Female"))),
         SeniorCitizen = factor(SeniorCitizen, levels=(c("Yes","No"))),
         Partner = factor(Partner, levels=(c("Yes","No"))),
         Dependents = factor(Dependents, levels=(c("Yes","No"))),
         PhoneService = factor(PhoneService, levels=(c("Yes","No"))),
         OnlineSecurity = factor(OnlineSecurity, levels=(c("Yes","No"))),
         OnlineBackup = factor(OnlineBackup, levels=(c("Yes","No"))),
         DeviceProtection = factor(DeviceProtection, levels=(c("Yes","No"))),
         TechSupport = factor(TechSupport, levels=(c("Yes","No"))),
         StreamingTV = factor(StreamingTV, levels=(c("Yes","No"))),
         StreamingMovies = factor(StreamingMovies, levels=(c("Yes","No"))),
         PaperlessBilling = factor(PaperlessBilling, levels=(c("Yes","No"))),
         ChurnLabel = factor(ChurnLabel, levels=(c("No","Yes"))))
...
```{r}
# print("Gender")
# contrasts(newdata$Gender)
# print("Senior Citizen")
# contrasts(newdata$SeniorCitizen)
# print("Partner")
# contrasts(newdata$Partner)
# print("Dependents")
# contrasts(newdata$Dependents)
# print("Phone Service")
# contrasts(newdata$PhoneService)
# print("Online Security")
# contrasts(newdata$OnlineSecurity)
# print("Online Backup")
# contrasts(newdata$OnlineBackup)
# print("Device Protection")
# contrasts(newdata$DeviceProtection)
# print("Tech Support")
# contrasts(newdata$TechSupport)
# print("Streaming TV")
# contrasts(newdata$StreamingTV)
# print("Streaming Movies")
# contrasts(newdata$StreamingMovies)
# print("Paperless Billing")
# contrasts(newdata$PaperlessBilling)
print("Churn Label")
...
```{r}
# glm to see important features
model1<- glm(Churn.Value~., family = binomial, data = newdata)
summary(model1)
```
